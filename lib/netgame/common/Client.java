...
/**
 * This abstract class represents a PlayerTerminal, or Player, that can connect
 ...
 * Each player in the game will have an associated PlayerTerminal object,
 ...
 * be defined to say how the PlayerTerminal should respond when a message is
...
abstract public class Client {
    ...
    private  class ConnectionToHub {
        ...
        private class SendThread extends Thread {
            public void run() {
                System.out.println("PlayerTerminal send thread started.");
                try {
                    while ( ! closed ) {
                    ...
                    if ( ! closed ) {
                        ...
                        System.out.println("PlayerTerminal send thread terminated by IOException: " + e);
                    }
                }
                catch (Exception e) {
                    if ( ! closed ) {
                    ...
                    System.out.println("PlayerTerminal send thread terminated.");
                }
            }
        }
        ...
        private class ReceiveThread extends Thread {
            public void run() {
                System.out.println("PlayerTerminal receive thread started.");
                try {
                    while ( ! closed ) {
                    ...
                    if ( ! closed ) {
                        ...
                        System.out.println("PlayerTerminal receive thread terminated by IOException: " + e);
                    }
                }
                catch (Exception e) {
                    if ( ! closed ) {
                    ...
                    System.out.println("PlayerTerminal receive thread terminated.");
                }
            }
        }
